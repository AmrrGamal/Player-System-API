...
public class PlayerController {
	...
	// HERE he make 2 fun for add and update because no frontend and he can select the req method (put or post)
	// in spring boot project he make 1 fun for add and update because he has frontend and he can NOT select the req method SO BOTH Is post 
